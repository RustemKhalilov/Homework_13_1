...
def test_Category():
    Product_1 = Product("Карандаш", "Канцтовары", 35.43, 105, 'nocolor')
...
def test_Product():
    Product_1 = Product("Карандаш", "Канцтовары", 35.43, 523, 'nocolor')
    ...
    assert Product_1.price == 35.43
    assert Product_1.color == 'nocolor'


def test_counter_category():
    Product_1 = Product("Карандаши", "Канцтовары", 35.43, 105, 'nocolor')
    product_list = [{'name': Product_1.name, 'quantity': Product_1.quantity, 'price': Product_1.price}]
    category_1 = Category("Канцтовары", "Карандаши", product_list)


    Product_2 = Product("Помидоры", "Продукты", 150, 305, 'nocolor')
